...
if rg -n "$PATTERN" README.md docs src include tests ops compose.yaml CMakeLists.txt .gitignore schemas fixtures data/generated/evidence \
  ...
  | rg -v '^src/collatz_evidence_publish\.cpp:[0-9]+:.*unsafe_public_text'; then
