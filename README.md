...
- Audit: `1,010,000,000` rows over `1..1,010,000,000`; full audit completed: `true`.
- Coverage: topology `113,970` rows (`0.011%` of audit); stratified evidence sample `113,970` rows (`0.011%`).
